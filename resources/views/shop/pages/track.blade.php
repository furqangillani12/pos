        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-xl p-8">
            <div class="text-center mb-6">
                <div class="w-14 h-14 rounded-2xl mx-auto flex items-center justify-center mb-4"
                     style="background:linear-gradient(135deg,#fdeef0,#fef3c7);color:var(--brand-navy);">
            ...
            <form method="POST" action="{{ route('shop.track.find') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="order_number" required value="{{ old('order_number') }}"
                           placeholder="ASM1234" class="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500 focus:border-rose-500">
                </div>
                <div>
                    ...
                    <input type="text" name="contact" required value="{{ old('contact') }}"
                           placeholder="you@example.com or +92 300 1234567" class="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-rose-500 focus:border-rose-500">
                </div>
