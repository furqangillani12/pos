...
<section class="py-10 sm:py-14">
    <div class="max-w-4xl mx-auto px-4 reveal">
        <a href="{{ route('shop.track') }}" class="text-xs text-gray-500 hover:text-cyan-700 inline-flex items-center gap-2 mb-4"><i class="fas fa-arrow-left"></i> Track another order</a>
