...
<head>
    ...
    <style>
        :root {
            /* ── Brand palette matched to the AL MUFEED TRADERS logo ───────
               Royal blue + bright cyan (silver/white). Variable NAMES kept
               stable so every shop page inherits the theme automatically. */
            --brand-navy:  #1b1f5c;   /* deep royal navy — dark surfaces/headings */
            --brand-blue:  #2e3192;   /* ROYAL BLUE — logo "AL MUFEED"            */
            --brand-cyan:  #1c9fd8;   /* CYAN — logo "TRADERS"/monogram, accent   */
            --brand-light: #29abe2;   /* bright cyan — hovers / highlights        */
            --rose:        #2e3192;   /* primary (royal blue) — buttons/eyebrows  */
            --rose-deep:   #232763;   /* darker royal                             */
            --gold:        #29abe2;   /* secondary accent → cyan                  */
            --gold-deep:   #1c9fd8;
            --paper:       #f6f9fc;   /* cool light page background               */
