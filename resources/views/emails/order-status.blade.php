...
<body style="margin:0;background:#faf7f7;font-family:Arial,Helvetica,sans-serif;color:#2b2127;">
    <div style="max-width:560px;margin:0 auto;padding:24px;">
        <div style="background:#1f1517;border-radius:14px 14px 0 0;padding:22px 24px;text-align:center;">
            <div style="color:#fff;font-size:18px;font-weight:bold;letter-spacing:.5px;">AL MUFEED TRADERS</div>
        </div>
        <div style="background:#fff;border:1px solid #eee;border-top:none;border-radius:0 0 14px 14px;padding:26px 24px;">
            <h1 style="margin:0 0 10px;font-size:20px;color:#be123c;">{{ $content['heading'] }}</h1>
            ...
            @endphp
            <a href="{{ $trackUrl }}" style="display:inline-block;background:#be123c;color:#fff;text-decoration:none;font-weight:bold;font-size:14px;padding:11px 22px;border-radius:10px;">Track your order</a>
        ...
        <p style="text-align:center;font-size:11px;color:#bbb;margin:16px 0 0;">&copy; {{ now()->year }} AL MUFEED TRADERS</p>
    </div>
</body>
</html>
