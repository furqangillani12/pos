                    ...
                    @forelse($categories as $category)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                @if ((int) ($category->sort_order ?? 0) >= 1)
                                    <span class="inline-flex items-center justify-center w-7 h-7 rounded-full bg-indigo-100 text-indigo-800 text-sm font-bold">{{ (int) $category->sort_order }}</span>
                                @else
