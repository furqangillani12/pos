...
class LedgerController extends Controller
{
    ...
    {
        // Don't let a branch open another branch's entry by guessing the id (#6).
        if (! $this->isAllBranches() && $ledger->branch_id && (string) $ledger->branch_id !== (string) $this->branchId()) {
            abort(403);
        }
